            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post">
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control <?= $class_name ?>" name="name" placeholder="name" value="<?= $dataPg->name ?>">
                        ...
                        <div class="mb-3">
                            <textarea class="form-control <?= $class_value ?>" name="value" placeholder="value"><?= json_decode($dataPg->data) ?></textarea>
