            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post">
                        ...
                        <div class="mb-3">
                            <select name="setting_type_id" class="form-select <?= $class_setting_type_id ?>">
                                ...
                                <?php foreach ($settingsType as $type) : ?>
                                    <option value="<?= $type->id ?>" <?=$setting_type_id == $type->id ? 'selected' : ''?>><?= $type->name ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control <?= $class_value  ?>" name="value" placeholder="value " value="<?= $value  ?>">
